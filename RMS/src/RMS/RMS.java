...
//	}
	...
	public void RTC() throws InterruptedException {
		...
		// driver.findElement(By.xpath("//mat-tab-body[contains(@id,'mat-tab-content-4-1')]//p[contains(@class,'error_msg
		// error-sms-Interval ng-star-inserted')]")).getText();
		...
		// Meter
		driver.findElement(By.xpath("//*[@id=\"btnadminaddsiteAddicon0\"]//img[@class=\"ursor-pointer comman-icon\"]"))
				.click();
	...
	public void startdashboard() throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"//div[contains(@class,'text-right flow-right')]//img[contains(@class,'img-fluid closeicon2 cursor-pointer')]"))
				.click();
		System.out.println("cancel");
		Thread.sleep(2000);
	}
	...
	public void flowdashboard() throws InterruptedException {
		...
		// datepicker
		driver.findElement(By.xpath("//button[contains(@class,'mat-focus-indicator mat-icon-button mat-button-base')]"))
				.click();
		System.out.println("open date picker");
		Thread.sleep(2000);

		driver.findElement(By.xpath("//*[@id=\"mat-datepicker-0\"]/div/mat-month-view/table/tbody/tr[2]/td[5]/div[1]"))
				.click();
...
//	      Thread.sleep(2000);   
	...
	public void Reportconfig() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(
				By.xpath("//mat-option[contains(@id,'mat-option-1')]//span[contains(@class,'mat-option-text')]"))
				.click();
		Thread.sleep(2000);
